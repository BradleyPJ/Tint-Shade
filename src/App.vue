...
import TintShade from './components/tint-shade.vue'
...
.btn:focus {
  ...
  background: -webkit-gradient(
    ...
    right top,
    color-stop(8%, #027991),
    color-stop(99%, #3c0979)
  );
  background: linear-gradient(90deg, #027991 8%, #3c0979 99%);
}
...
#includeHashWrap #includeHashMessage {
  color: #efefef;
}
</style>
